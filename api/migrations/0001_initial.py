    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('height_unit', models.CharField(blank=True, max_length=100, verbose_name='Height Unit')),
                ('weight_unit', models.CharField(blank=True, max_length=100, verbose_name='Weight Unit')),
                ('age', models.SmallIntegerField(blank=True, verbose_name='Age')),
                ('school', models.CharField(blank=True, max_length=150, verbose_name='School')),
                ('sport', models.CharField(blank=True, max_length=150, verbose_name='Sport')),
                ...
                ('is_client', models.BooleanField(default=False, help_text='Designates whether this user should be treated as a Client. ', verbose_name='Client')),
